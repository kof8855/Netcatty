import { FolderTree, MessageSquare, Monitor, PanelLeft, PanelRight, Palette, X, Zap } from 'lucide-react';
...
import { HostListSidePanel } from './HostListSidePanel';
...
const TerminalLayerInner: React.FC<TerminalLayerProps> = ({
  ...
  /** ENHANCED: Open hosts tab in side panel */
  const handleOpenHosts = useCallback(() => {
    handleSwitchSidePanelTab('hosts');
  }, [handleSwitchSidePanelTab]);
